...
namespace UiPath.Web.Client20183.Models
{
    ...
    public partial class SimpleReleaseDto
    {
        ...
        /// the release</param>
        public SimpleReleaseDto(string processKey, string processVersion, string name, long environmentId, string key = default(string), bool? isLatestVersion = default(bool?), bool? isProcessDeleted = default(bool?), string description = default(string), string environmentName = default(string), EnvironmentDto environment = default(EnvironmentDto), string inputArguments = default(string), ReleaseVersionDto currentVersion = default(ReleaseVersionDto), IList<ReleaseVersionDto> releaseVersions = default(IList<ReleaseVersionDto>), ArgumentMetadata arguments = default(ArgumentMetadata), long? id = default(long?))
        {
            Key = key;
