...
namespace UiPath.Web.Client202010.Models
{
    ...
    public partial class TaskCreateRequest
    {
        ...
        public TaskCreateRequest(string title, TaskCreateRequestType? type = default(TaskCreateRequestType?), string externalTag = default(string), BaseTaskCreateRequestPriority? priority = default(BaseTaskCreateRequestPriority?), object data = default(object), string taskCatalogName = default(string))
        {
            Type = type;
