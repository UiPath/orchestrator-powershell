...
namespace UiPath.Web.Client20204
{
    ...
    public partial interface IFoldersNavigation
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<UserRoleAssignmentsDto>> GetAllRolesForUserWithHttpMessagesAsync(string username, int skip, int take, Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    }
}
