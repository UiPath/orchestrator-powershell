...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class ProcessSchedulesExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataValueBoolean> SetEnabledAsync(this IProcessSchedules operations, SetEnabledParameters setEnabledParameters, long? xUIPATHOrganizationUnitId = default(long?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
