...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class HostLicensesExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerableHostLicenseDto Get(this IHostLicenses operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?))
            {
            ...
            /// <param name='activateLicenseParameters'>
            /// </param>
            public static ODataValueString GetLicenseOffline(this IHostLicenses operations, ActivateLicenseParameters activateLicenseParameters = default(ActivateLicenseParameters))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataValueString> GetLicenseOfflineAsync(this IHostLicenses operations, ActivateLicenseParameters activateLicenseParameters = default(ActivateLicenseParameters), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
