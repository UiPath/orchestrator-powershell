...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class MachinesExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerableExtendedMachineDto Get(this IMachines operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?))
            {
            ...
            /// <param name='folderId'>
            /// </param>
            public static ODataValueIEnumerableMachineRuntimeDto GetRuntimesForFolderByFolderid(this IMachines operations, long folderId)
            {
                return operations.GetRuntimesForFolderByFolderidAsync(folderId).GetAwaiter().GetResult();
            }
