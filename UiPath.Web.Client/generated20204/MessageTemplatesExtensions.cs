...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class MessageTemplatesExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerableMessageTemplateDto Get(this IMessageTemplates operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?))
            {
            ...
            /// </param>
            public static async Task<ODataValueIEnumerableMessageTemplateDto> GetAsync(this IMessageTemplates operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
