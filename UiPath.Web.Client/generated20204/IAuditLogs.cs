...
namespace UiPath.Web.Client20204
{
    ...
    public partial interface IAuditLogs
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<ODataValueIEnumerableAuditLogEntityDto>> GetAuditLogDetailsByAuditlogidWithHttpMessagesAsync(long auditLogId, Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
