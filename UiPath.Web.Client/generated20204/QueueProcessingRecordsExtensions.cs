...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class QueueProcessingRecordsExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerableQueueProcessingRecordDto RetrieveLastDaysProcessingRecordsByDaysnoAndQueuedefinitionid(this IQueueProcessingRecords operations, int daysNo, long queueDefinitionId, long? xUIPATHOrganizationUnitId = default(long?))
            {
            ...
            /// </param>
            public static async Task<ODataValueIEnumerableQueueProcessingRecordDto> RetrieveLastDaysProcessingRecordsByDaysnoAndQueuedefinitionidAsync(this IQueueProcessingRecords operations, int daysNo, long queueDefinitionId, long? xUIPATHOrganizationUnitId = default(long?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.RetrieveLastDaysProcessingRecordsByDaysnoAndQueuedefinitionidWithHttpMessagesAsync(daysNo, queueDefinitionId, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataValueIEnumerableQueueProcessingStatusDto> RetrieveQueuesProcessingStatusAsync(this IQueueProcessingRecords operations, long? xUIPATHOrganizationUnitId = default(long?), string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
