...
namespace UiPath.Web.Client20204.Models
{
    ...
    public partial class SimpleReleaseDto
    {
        ...
        /// 'High'</param>
        public SimpleReleaseDto(string processKey, string processVersion, string name, string key = default(string), bool? isLatestVersion = default(bool?), bool? isProcessDeleted = default(bool?), string description = default(string), long? environmentId = default(long?), string environmentName = default(string), EnvironmentDto environment = default(EnvironmentDto), string inputArguments = default(string), SimpleReleaseDtoProcessType? processType = default(SimpleReleaseDtoProcessType?), bool? supportsMultipleEntryPoints = default(bool?), bool? requiresUserInteraction = default(bool?), ReleaseVersionDto currentVersion = default(ReleaseVersionDto), IList<ReleaseVersionDto> releaseVersions = default(IList<ReleaseVersionDto>), ArgumentMetadata arguments = default(ArgumentMetadata), ProcessSettingsDto processSettings = default(ProcessSettingsDto), bool? autoUpdate = default(bool?), SimpleReleaseDtoJobPriority? jobPriority = default(SimpleReleaseDtoJobPriority?), long? id = default(long?))
        {
            Key = key;
        ...
        public SimpleReleaseDtoProcessType? ProcessType { get; set; }
        ...
        public SimpleReleaseDtoJobPriority? JobPriority { get; set; }
