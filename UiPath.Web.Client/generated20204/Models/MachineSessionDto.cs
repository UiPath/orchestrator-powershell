...
namespace UiPath.Web.Client20204.Models
{
    ...
    public partial class MachineSessionDto
    {
        ...
        public MachineSessionDto(string version = default(string), string serviceUserName = default(string), RobotWithLicenseDto robot = default(RobotWithLicenseDto), string hostMachineName = default(string), long? machineId = default(long?), string machineName = default(string), MachineSessionDtoState? state = default(MachineSessionDtoState?), JobDto job = default(JobDto), System.DateTime? reportingTime = default(System.DateTime?), string info = default(string), bool? isUnresponsive = default(bool?), MachineSessionDtoLicenseErrorCode? licenseErrorCode = default(MachineSessionDtoLicenseErrorCode?), long? organizationUnitId = default(long?), string folderName = default(string), long? id = default(long?))
        {
            Version = version;
        ...
        public MachineSessionDtoState? State { get; set; }
        ...
        public MachineSessionDtoLicenseErrorCode? LicenseErrorCode { get; set; }
