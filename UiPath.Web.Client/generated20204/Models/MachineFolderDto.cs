...
namespace UiPath.Web.Client20204.Models
{
    ...
    public partial class MachineFolderDto
    {
        ...
        /// the Machine.</param>
        public MachineFolderDto(string name, bool? isAssignedToFolder = default(bool?), string licenseKey = default(string), string description = default(string), MachineFolderDtoType? type = default(MachineFolderDtoType?), int? nonProductionSlots = default(int?), int? unattendedSlots = default(int?), int? headlessSlots = default(int?), int? testAutomationSlots = default(int?), IList<MachinesRobotVersionDto> robotVersions = default(IList<MachinesRobotVersionDto>), long? id = default(long?))
        {
        ...
        public MachineFolderDtoType? Type { get; set; }
