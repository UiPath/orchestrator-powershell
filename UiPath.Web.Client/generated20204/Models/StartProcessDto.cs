...
namespace UiPath.Web.Client20204.Models
{
    ...
    public partial class StartProcessDto
    {
        ...
        public StartProcessDto(string releaseKey, StartProcessDtoStrategy? strategy = default(StartProcessDtoStrategy?), IList<long?> robotIds = default(IList<long?>), int? noOfRobots = default(int?), int? jobsCount = default(int?), StartProcessDtoSource? source = default(StartProcessDtoSource?), StartProcessDtoJobPriority? jobPriority = default(StartProcessDtoJobPriority?), StartProcessDtoRuntimeType? runtimeType = default(StartProcessDtoRuntimeType?), string inputArguments = default(string))
        {
