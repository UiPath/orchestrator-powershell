...
namespace UiPath.Web.Client20204.Models
{
    ...
    public partial class FormTaskCreateRequest
    {
        ...
        public FormTaskCreateRequest(string title, object formLayout = default(object), FormTaskCreateRequestPriority? priority = default(FormTaskCreateRequestPriority?), object data = default(object), string taskCatalogName = default(string))
        {
        ...
        public FormTaskCreateRequestPriority? Priority { get; set; }
