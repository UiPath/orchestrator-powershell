...
namespace UiPath.Web.Client20204.Models
{
    ...
    public partial class ExtendedMachineDto
    {
        ...
        /// the Machine.</param>
        public ExtendedMachineDto(string name, string licenseKey = default(string), string description = default(string), ExtendedMachineDtoType? type = default(ExtendedMachineDtoType?), int? nonProductionSlots = default(int?), int? unattendedSlots = default(int?), int? headlessSlots = default(int?), int? testAutomationSlots = default(int?), IList<MachinesRobotVersionDto> robotVersions = default(IList<MachinesRobotVersionDto>), long? id = default(long?))
        {
        ...
        public ExtendedMachineDtoType? Type { get; set; }
