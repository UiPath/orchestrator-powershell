...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class PermissionsExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerablePermissionDto Get(this IPermissions operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?))
            {
