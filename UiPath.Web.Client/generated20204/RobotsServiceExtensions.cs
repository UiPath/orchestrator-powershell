...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class RobotsServiceExtensions
    {
            ...
            /// <param name='payload'>
            /// </param>
            public static HeartbeatResponse HeartbeatV2(this IRobotsService operations, HeartbeatPayload payload)
            {
                return operations.HeartbeatV2Async(payload).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<HeartbeatResponse> HeartbeatV2Async(this IRobotsService operations, HeartbeatPayload payload, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.HeartbeatV2WithHttpMessagesAsync(payload, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
