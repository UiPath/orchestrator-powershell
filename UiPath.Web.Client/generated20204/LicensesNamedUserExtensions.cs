...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class LicensesNamedUserExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerableLicenseNamedUserDto GetLicensesNamedUserByRobottype(this ILicensesNamedUser operations, string robotType, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?))
            {
