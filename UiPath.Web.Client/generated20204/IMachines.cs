...
namespace UiPath.Web.Client20204
{
    ...
    public partial interface IMachines
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<ODataValueIEnumerableMachineRuntimeDto>> GetRuntimesForFolderByFolderidWithHttpMessagesAsync(long folderId, Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    }
}
