...
namespace UiPath.Web.Client20204
{
    ...
    public static partial class TestSetSchedulesExtensions
    {
            ...
            /// </param>
            public static ODataValueIEnumerableTestSetScheduleDto Get(this ITestSetSchedules operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), long? xUIPATHOrganizationUnitId = default(long?))
            {
            ...
            /// Folder/OrganizationUnit Id
            /// </param>
            public static TestSetScheduleDto Post(this ITestSetSchedules operations, TestSetScheduleDto testSetScheduleDto, long? xUIPATHOrganizationUnitId = default(long?))
            {
                return operations.PostAsync(testSetScheduleDto, xUIPATHOrganizationUnitId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TestSetScheduleDto> PostAsync(this ITestSetSchedules operations, TestSetScheduleDto testSetScheduleDto, long? xUIPATHOrganizationUnitId = default(long?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.PostWithHttpMessagesAsync(testSetScheduleDto, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Folder/OrganizationUnit Id
            /// </param>
            public static TestSetScheduleDto GetById(this ITestSetSchedules operations, long id, string expand = default(string), string select = default(string), long? xUIPATHOrganizationUnitId = default(long?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TestSetScheduleDto> GetByIdAsync(this ITestSetSchedules operations, long id, string expand = default(string), string select = default(string), long? xUIPATHOrganizationUnitId = default(long?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
