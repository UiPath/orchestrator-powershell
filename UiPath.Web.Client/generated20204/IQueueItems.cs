...
namespace UiPath.Web.Client20204
{
    ...
    public partial interface IQueueItems
    {
        ...
        /// </exception>
        Task<HttpOperationResponse> PutByIdWithHttpMessagesAsync(long id, QueueItemDataDto queueItemDto, long? xUIPATHOrganizationUnitId = default(long?), Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
