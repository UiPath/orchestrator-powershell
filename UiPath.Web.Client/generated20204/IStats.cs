...
namespace UiPath.Web.Client20204
{
    ...
    public partial interface IStats
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<IList<ConsumptionLicenseStatsModel>>> GetConsumptionLicenseStatsWithHttpMessagesAsync(int tenantId, int days, Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    }
}
