...
namespace UiPath.Web.Client20181
{
    ...
    public static partial class EnvironmentsExtensions
    {
            ...
            /// </param>
            public static ODataResponseListRobotDto GetRobotsForEnvironmentByKey(this IEnvironments operations, long key)
            {
                return operations.GetRobotsForEnvironmentByKeyAsync(key).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataResponseListRobotDto> GetRobotsForEnvironmentByKeyAsync(this IEnvironments operations, long key, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.GetRobotsForEnvironmentByKeyWithHttpMessagesAsync(key, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
