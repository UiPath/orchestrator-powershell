...
namespace UiPath.Web.Client20181
{
    ...
    public static partial class QueueDefinitionsExtensions
    {
            ...
            /// key: Id
            /// </param>
            public static object ReportsById(this IQueueDefinitions operations, long id)
            {
                return operations.ReportsByIdAsync(id).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> ReportsByIdAsync(this IQueueDefinitions operations, long id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.ReportsByIdWithHttpMessagesAsync(id, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
