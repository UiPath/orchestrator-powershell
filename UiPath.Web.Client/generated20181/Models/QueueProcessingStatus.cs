...
namespace UiPath.Web.Client20181.Models
{
    ...
    /// </summary>
    public partial class QueueProcessingStatus
    {
        /// <summary>
        /// Initializes a new instance of the QueueProcessingStatus class.
        /// </summary>
        public QueueProcessingStatus()
        {
            CustomInit();
        }
        ...
        /// processing.</param>
        public QueueProcessingStatus(int? itemsToProcess = default(int?), int? itemsInProgress = default(int?), long? queueDefinitionId = default(long?), string queueDefinitionName = default(string), string queueDefinitionDescription = default(string), bool? queueDefinitionAcceptAutomaticallyRetry = default(bool?), int? queueDefinitionMaxNumberOfRetries = default(int?), bool? queueDefinitionEnforceUniqueReference = default(bool?), decimal? processingMeanTime = default(decimal?), int? successfulTransactionsNo = default(int?), int? applicationExceptionsNo = default(int?), int? businessExceptionsNo = default(int?), decimal? successfulTransactionsProcessingTime = default(decimal?), decimal? applicationExceptionsProcessingTime = default(decimal?), decimal? businessExceptionsProcessingTime = default(decimal?), int? totalNumberOfTransactions = default(int?), System.DateTime? lastProcessed = default(System.DateTime?))
        {
