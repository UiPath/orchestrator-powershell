...
namespace UiPath.Web.Client20181.Models
{
    ...
    public partial class SimpleRobotDto
    {
        ...
        public SimpleRobotDto(string licenseKey, string machineName, string name, SimpleRobotDtoType type, string username = default(string), string description = default(string), string password = default(string), IList<EnvironmentDto> environments = default(IList<EnvironmentDto>), string robotEnvironments = default(string), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), long? id = default(long?))
        {
