...
namespace UiPath.Web.Client20181.Models
{
    ...
    public partial class TransactionDataDto
    {
        ...
        public TransactionDataDto(string name = default(string), System.Guid? robotIdentifier = default(System.Guid?), QueueItemSpecificContent specificContent = default(QueueItemSpecificContent), System.DateTime? deferDate = default(System.DateTime?), System.DateTime? dueDate = default(System.DateTime?), string reference = default(string))
        {
            Name = name;
