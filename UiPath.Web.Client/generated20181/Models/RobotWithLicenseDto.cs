...
namespace UiPath.Web.Client20181.Models
{
    ...
    public partial class RobotWithLicenseDto
    {
        ...
        public RobotWithLicenseDto(string licenseKey, string machineName, string name, RobotWithLicenseDtoType type, RobotLicenseDto license = default(RobotLicenseDto), string username = default(string), string description = default(string), string password = default(string), IList<EnvironmentDto> environments = default(IList<EnvironmentDto>), string robotEnvironments = default(string), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), long? id = default(long?))
        {
            License = license;
