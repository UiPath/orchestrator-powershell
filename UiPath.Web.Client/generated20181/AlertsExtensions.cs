...
namespace UiPath.Web.Client20181
{
    ...
    public static partial class AlertsExtensions
    {
            ...
            /// </param>
            public static void RaiseProcessAlert(this IAlerts operations, Parameters parameters = default(Parameters))
            {
                operations.RaiseProcessAlertAsync(parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task RaiseProcessAlertAsync(this IAlerts operations, Parameters parameters = default(Parameters), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                (await operations.RaiseProcessAlertWithHttpMessagesAsync(parameters, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
