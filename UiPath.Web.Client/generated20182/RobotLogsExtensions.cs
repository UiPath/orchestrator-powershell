...
namespace UiPath.Web.Client20182
{
    ...
    public static partial class RobotLogsExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static ODataResponseInt64 GetTotalCount(this IRobotLogs operations)
            {
                return operations.GetTotalCountAsync().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataResponseInt64> GetTotalCountAsync(this IRobotLogs operations, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.GetTotalCountWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
