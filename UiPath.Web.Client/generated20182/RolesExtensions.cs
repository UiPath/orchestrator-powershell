...
namespace UiPath.Web.Client20182
{
    ...
    public static partial class RolesExtensions
    {
            ...
            /// </param>
            public static ODataResponseListUserDto GetUsersForRoleByKey(this IRoles operations, int key)
            {
                return operations.GetUsersForRoleByKeyAsync(key).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataResponseListUserDto> GetUsersForRoleByKeyAsync(this IRoles operations, int key, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.GetUsersForRoleByKeyWithHttpMessagesAsync(key, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
