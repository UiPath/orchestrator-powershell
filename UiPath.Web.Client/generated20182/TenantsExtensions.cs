...
namespace UiPath.Web.Client20182
{
    ...
    public static partial class TenantsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TenantDto> PutByIdAsync(this ITenants operations, int id, TenantDto tenantDto, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.PutByIdWithHttpMessagesAsync(id, tenantDto, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
