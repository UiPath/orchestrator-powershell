...
namespace UiPath.Web.Client20182
{
    ...
    public static partial class QueueDefinitionsExtensions
    {
            ...
            /// key: Id
            /// </param>
            public static Stream ReportsById(this IQueueDefinitions operations, long id)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Stream> ReportsByIdAsync(this IQueueDefinitions operations, long id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                var _result = await operations.ReportsByIdWithHttpMessagesAsync(id, null, cancellationToken).ConfigureAwait(false);
