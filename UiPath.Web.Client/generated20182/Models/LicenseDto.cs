...
namespace UiPath.Web.Client20182.Models
{
    ...
    public partial class LicenseDto
    {
        ...
        /// or not.</param>
        public LicenseDto(long? expireDate = default(long?), LicenseFields allowed = default(LicenseFields), LicenseFields used = default(LicenseFields), bool? attendedConcurrent = default(bool?), bool? developmentConcurrent = default(bool?), bool? isRegistered = default(bool?), bool? isExpired = default(bool?))
        {
