...
namespace UiPath.Web.Client20182.Models
{
    ...
    public partial class LicenseRuntimeDto
    {
        ...
        public LicenseRuntimeDto(string key = default(string), long? machineId = default(long?), string machineName = default(string), int? runtimes = default(int?), int? robotsCount = default(int?), int? executingCount = default(int?), bool? isOnline = default(bool?), bool? isLicensed = default(bool?))
        {
            Key = key;
            MachineId = machineId;
