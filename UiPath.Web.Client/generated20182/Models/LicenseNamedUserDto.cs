...
namespace UiPath.Web.Client20182.Models
{
    ...
    public partial class LicenseNamedUserDto
    {
        ...
        /// license.</param>
        /// <param name="machineNames">The Machine name of the Robot that uses
        /// the license.</param>
        public LicenseNamedUserDto(string key = default(string), string userName = default(string), System.DateTime? lastLoginDate = default(System.DateTime?), int? machinesCount = default(int?), bool? isLicensed = default(bool?), long? activeRobotId = default(long?), IList<string> machineNames = default(IList<string>))
        {
            Key = key;
            UserName = userName;
        ...
        /// <summary>
        /// Gets or sets the Machine name of the Robot that uses the license.
        /// </summary>
