...
namespace UiPath.Web.Client20182.Models
{
    ...
    public partial class RobotCommand
    {
        ...
        public RobotCommand(string robotKey = default(string), string username = default(string), string robotName = default(string), RobotCommandRobotType? robotType = default(RobotCommandRobotType?), bool? hasLicense = default(bool?), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), Command data = default(Command))
        {
            RobotKey = robotKey;
            Username = username;
            RobotName = robotName;
