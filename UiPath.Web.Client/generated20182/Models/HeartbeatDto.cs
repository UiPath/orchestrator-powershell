...
namespace UiPath.Web.Client20182.Models
{
    ...
    public partial class HeartbeatDto
    {
        ...
        /// 'Stopped'</param>
        public HeartbeatDto(string robotKey = default(string), HeartbeatDtoRobotState? robotState = default(HeartbeatDtoRobotState?), HeartbeatDtoJobState? jobState = default(HeartbeatDtoJobState?), string jobKey = default(string), string processKey = default(string), string info = default(string))
        {
            RobotKey = robotKey;
