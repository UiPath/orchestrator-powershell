...
namespace UiPath.Web.Client20182.Models
{
    ...
    public partial class EnvironmentDto
    {
        ...
        /// <param name="type">The environment type specifies how it should be
        /// used. Possible values include: 'Dev', 'Test', 'Prod'</param>
        ...
        public EnvironmentDto(string name, EnvironmentDtoType type, string description = default(string), IList<SimpleRobotDto> robots = default(IList<SimpleRobotDto>), long? id = default(long?))
        {
            Name = name;
        ...
        /// <summary>
        /// Gets or sets the environment type specifies how it should be used.
        /// Possible values include: 'Dev', 'Test', 'Prod'
        /// </summary>
