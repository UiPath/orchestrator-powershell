...
namespace UiPath.Web.Client20182
{
    ...
    public static partial class RobotsExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static ODataResponseListKeyValuePairStringString GetUsernames(this IRobots operations)
            {
                return operations.GetUsernamesAsync().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataResponseListKeyValuePairStringString> GetUsernamesAsync(this IRobots operations, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.GetUsernamesWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
