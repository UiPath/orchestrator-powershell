...
namespace UiPath.Web.Client201910
{
    ...
    public static partial class QueueDefinitionsExtensions
    {
            ...
            /// </param>
            public static ODataResponseListQueueDefinitionDto GetQueueDefinitions(this IQueueDefinitions operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), long? xUIPATHOrganizationUnitId = default(long?))
            {
                return operations.GetQueueDefinitionsAsync(expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.GetQueueDefinitionsWithHttpMessagesAsync(expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
