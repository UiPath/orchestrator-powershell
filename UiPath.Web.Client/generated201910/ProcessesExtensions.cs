...
namespace UiPath.Web.Client201910
{
    ...
    public static partial class ProcessesExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataResponseListBulkItemDtoString> UploadPackageAsync(this IProcesses operations, Stream file, Stream file1 = default(Stream), Stream file2 = default(Stream), Stream file3 = default(Stream), Stream file4 = default(Stream), Stream file5 = default(Stream), Stream file6 = default(Stream), Stream file7 = default(Stream), Stream file8 = default(Stream), Stream file9 = default(Stream), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
