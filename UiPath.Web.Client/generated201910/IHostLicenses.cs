...
namespace UiPath.Web.Client201910
{
    ...
    public partial interface IHostLicenses
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<string>> GetDeactivateLicenseOfflineWithHttpMessagesAsync(DeactivateLicenseOfflineParameters deactivateLicenseOfflineParameters = default(DeactivateLicenseOfflineParameters), Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
