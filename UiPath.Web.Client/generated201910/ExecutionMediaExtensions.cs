...
namespace UiPath.Web.Client201910
{
    ...
    public static partial class ExecutionMediaExtensions
    {
            ...
            {
                using (var _result = await operations.GetExecutionMediaWithHttpMessagesAsync(expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
