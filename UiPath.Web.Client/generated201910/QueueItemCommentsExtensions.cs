...
namespace UiPath.Web.Client201910
{
    ...
    public static partial class QueueItemCommentsExtensions
    {
            ...
            /// </param>
            public static ODataResponseListQueueItemCommentDto GetQueueItemComments(this IQueueItemComments operations, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), long? xUIPATHOrganizationUnitId = default(long?))
            {
                return operations.GetQueueItemCommentsAsync(expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.GetQueueItemCommentsWithHttpMessagesAsync(expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Folder/OrganizationUnit Id
            /// </param>
            public static object PutById(this IQueueItemComments operations, long id, QueueItemCommentDto queueItemCommentDto, long? xUIPATHOrganizationUnitId = default(long?))
            {
                return operations.PutByIdAsync(id, queueItemCommentDto, xUIPATHOrganizationUnitId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> PutByIdAsync(this IQueueItemComments operations, long id, QueueItemCommentDto queueItemCommentDto, long? xUIPATHOrganizationUnitId = default(long?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.PutByIdWithHttpMessagesAsync(id, queueItemCommentDto, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
