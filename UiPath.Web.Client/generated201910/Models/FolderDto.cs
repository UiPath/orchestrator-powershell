...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class FolderDto
    {
        ...
        /// hierarchy</param>
        public FolderDto(string displayName, string fullyQualifiedName = default(string), string description = default(string), FolderDtoProvisionType? provisionType = default(FolderDtoProvisionType?), FolderDtoPermissionModel? permissionModel = default(FolderDtoPermissionModel?), long? parentId = default(long?), long? id = default(long?))
        {
