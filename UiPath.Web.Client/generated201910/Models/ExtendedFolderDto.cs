...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class ExtendedFolderDto
    {
        ...
        /// hierarchy</param>
        public ExtendedFolderDto(string displayName, bool? isSelectable = default(bool?), bool? hasChildren = default(bool?), int? level = default(int?), string fullyQualifiedName = default(string), string description = default(string), ExtendedFolderDtoProvisionType? provisionType = default(ExtendedFolderDtoProvisionType?), ExtendedFolderDtoPermissionModel? permissionModel = default(ExtendedFolderDtoPermissionModel?), long? parentId = default(long?), long? id = default(long?))
        {
