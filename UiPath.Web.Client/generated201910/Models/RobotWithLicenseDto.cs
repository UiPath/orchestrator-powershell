...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class RobotWithLicenseDto
    {
        ...
        public RobotWithLicenseDto(string name, string username, RobotWithLicenseDtoType type, RobotWithLicenseDtoHostingType hostingType, RobotWithLicenseDtoProvisionType provisionType, RobotLicenseDto license = default(RobotLicenseDto), string licenseKey = default(string), string machineName = default(string), long? machineId = default(long?), string externalName = default(string), string description = default(string), string version = default(string), string password = default(string), long? credentialStoreId = default(long?), long? userId = default(long?), RobotWithLicenseDtoCredentialType? credentialType = default(RobotWithLicenseDtoCredentialType?), IList<EnvironmentDto> environments = default(IList<EnvironmentDto>), string robotEnvironments = default(string), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), bool? isExternalLicensed = default(bool?), long? id = default(long?))
        {
            License = license;
