...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class LicenseFields
    {
        ...
        /// Initializes a new instance of the LicenseFields class.
        /// </summary>
        public LicenseFields(long? unattended = default(long?), long? attended = default(long?), long? nonProduction = default(long?), long? development = default(long?), long? studioX = default(long?))
        {
