...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class SimpleRobotDto
    {
        ...
        public SimpleRobotDto(string name, string username, SimpleRobotDtoType type, SimpleRobotDtoHostingType hostingType, SimpleRobotDtoProvisionType provisionType, string licenseKey = default(string), string machineName = default(string), long? machineId = default(long?), string externalName = default(string), string description = default(string), string version = default(string), string password = default(string), long? credentialStoreId = default(long?), long? userId = default(long?), SimpleRobotDtoCredentialType? credentialType = default(SimpleRobotDtoCredentialType?), IList<EnvironmentDto> environments = default(IList<EnvironmentDto>), string robotEnvironments = default(string), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), bool? isExternalLicensed = default(bool?), long? id = default(long?))
        {
        ...
        public SimpleRobotDtoProvisionType ProvisionType { get; set; }
