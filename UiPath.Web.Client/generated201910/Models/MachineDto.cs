...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class MachineDto
    {
        ...
        /// the Machine.</param>
        public MachineDto(string name, string licenseKey = default(string), string description = default(string), MachineDtoType? type = default(MachineDtoType?), int? nonProductionSlots = default(int?), int? unattendedSlots = default(int?), IList<MachinesRobotVersionDto> robotVersions = default(IList<MachinesRobotVersionDto>), long? id = default(long?))
        {
