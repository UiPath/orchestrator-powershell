...
namespace UiPath.Web.Client201910.Models
{
    ...
    public partial class FormTaskCreateRequest
    {
        ...
        public FormTaskCreateRequest(string title, FormTaskCreateRequestPriority? priority = default(FormTaskCreateRequestPriority?), object formLayout = default(object), object data = default(object), string taskCatalogName = default(string))
        {
            Title = title;
            Priority = priority;
