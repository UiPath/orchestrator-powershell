...
namespace UiPath.Web.Client20191.Models
{
    ...
    public partial class QueueDefinitionDto
    {
        ...
        /// created.</param>
        public QueueDefinitionDto(string name, string description = default(string), int? maxNumberOfRetries = default(int?), bool? acceptAutomaticallyRetry = default(bool?), bool? enforceUniqueReference = default(bool?), System.DateTime? creationTime = default(System.DateTime?), long? id = default(long?))
        {
            Name = name;
