...
namespace UiPath.Web.Client20194
{
    ...
    public static partial class ReleasesExtensions
    {
            ...
            /// </param>
            public static BulkOperationResponseDtoInt64 UpdateToLatestPackageVersionBulk(this IReleases operations, UpdateToLatestBulk updateToLatestBulk)
            {
                return operations.UpdateToLatestPackageVersionBulkAsync(updateToLatestBulk).GetAwaiter().GetResult();
            }
