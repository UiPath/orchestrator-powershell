...
namespace UiPath.Web.Client20194
{
    ...
    public static partial class AssetsExtensions
    {
            ...
            /// </param>
            public static RobotAssetDto GetRobotAssetByRobotId(this IAssets operations, long robotId, string assetName)
            {
                return operations.GetRobotAssetByRobotIdAsync(robotId, assetName).GetAwaiter().GetResult();
            }
