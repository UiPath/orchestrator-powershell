...
namespace UiPath.Web.Client20184.Models
{
    ...
    public partial class JobDto
    {
        ...
        public JobDto(System.Guid? key = default(System.Guid?), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), JobDtoState? state = default(JobDtoState?), SimpleRobotDto robot = default(SimpleRobotDto), SimpleReleaseDto release = default(SimpleReleaseDto), string source = default(string), JobDtoSourceType? sourceType = default(JobDtoSourceType?), System.Guid? batchExecutionKey = default(System.Guid?), string info = default(string), System.DateTime? creationTime = default(System.DateTime?), long? startingScheduleId = default(long?), string releaseName = default(string), JobDtoType? type = default(JobDtoType?), string inputArguments = default(string), string outputArguments = default(string), string hostMachineName = default(string), long? id = default(long?))
        {
            Key = key;
            StartTime = startTime;
            EndTime = endTime;
